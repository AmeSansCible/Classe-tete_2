...
def create_connection(path):
    try:
        with sqlite3.connect(path) as connection:
            ...
            return connection  # La connexion sera fermée automatiquement après le bloc
    except Error as e:
        print(f"The error '{e}' occurred")
        return None


connection = create_connection("C:\\Users\\racli\\PycharmProjects\\Classe-tete\\database2.db")
